...
<head>
    ...
    <script src="http://item.pinyougou.com/plugins/angularjs/angular.min.js"></script>
    <script src="http://item.pinyougou.com/js/base.js"></script>
    <script src="http://item.pinyougou.com/js/controller/baseController.js"></script>
    <script src="http://item.pinyougou.com/js/controller/itemController.js"></script>
    <script type="text/javascript">
        // 定义SKU商品数据
        //把itemList转换为JSON字符串封装到Map,方便在页面取出,
        //不转换只能用ftl用表达式#list取出了
